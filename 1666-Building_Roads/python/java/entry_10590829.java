...
public class entry_10590829 {
    ...
    public static void dfs(int curr, int num, int[] groupNum, ArrayList<ArrayList<Integer>> adjList)
    {
        groupNum[curr] = num;
