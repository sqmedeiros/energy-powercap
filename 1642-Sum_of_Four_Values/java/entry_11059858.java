...
public class entry_11059858 extends Functions implements Debug {
    ...
    for (int i = 0; i < n; i++) {
      for (int j = i + 1; j < n; j++) {
        ...
        if (twoSum.containsKey(diff)) {
          ...
          // out.groupAppend(i + 1, " ", j + 1, " ", pair[0], " ", pair[1]);
...
@MultipleInheritanceDisallowed(inheritor = "entry_11059858")
...
class StandardOutputWriter {
  ...
  public StandardOutputWriter groupAppend(Object... __VA_ARGS___) {
    for (Object obj : __VA_ARGS___)
