...
public class entry_5123054
{
    ...
    public static void main (String[] args) throws java.lang.Exception
 {
     ...
     while(T-->0)
     {
      int n = get.nextInt(), e =get.nextInt();

      ArrayList<ArrayList<Integer>> adj = new ArrayList<>();
      for(int i=0; i<=n; i++) adj.add(new ArrayList<>());

      for(int i=0; i<e; i++) {
       int a = get.nextInt(), b=get.nextInt();
      ...
      while(!qq.isEmpty())
      {
       ...
       ArrayList<Integer> ll = adj.get(y);
      ...
      if(parent[n]==-1) {
       ...
       put.write(st.size()+"\n");
       while(!st.isEmpty()) put.write(st.pop()+" ");
      }
