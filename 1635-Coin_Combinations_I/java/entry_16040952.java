...
public class entry_16040952 {
    ...
    public static void solve() {
        ...
        /*
        * State: dp[x] = no. of ways to achieve the sum x
        * Transition: dp[x] = dp[x] += dp[x - c] where c is the coin which we are using
                      to achieve the sum x
        * TC: O(XN)
        */
