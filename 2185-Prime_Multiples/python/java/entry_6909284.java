...
public class entry_6909284 {
 ...
 void solve()
 {
  ...
  out.printLong(n-count(n, 0));
 }

 long count(long x, int pos)
 {
  if(x==0) return 0;
...
// 
 ...
 public entry_6909284(SuperQuickReader in, SuperQuickWriter out) {
  this.in = in;
  this.out = out;
 }
 ...
 public static void main(String[] args) throws IOException {
  ...
  {
   new entry_6909284(in, out).solve();
  }
 }
