...
public class entry_3278788 implements Runnable {
    ...
    private static long getNum(int row, int col) {
        int square = Math.max(row, col);
        long num = (long) (square-1) * (square-1);
