...
class entry_4889343
{
    ...
    public static void main (String[] args) throws java.lang.Exception
 {
     ...
     while(T-- > 0)
     {
         long a = get.nextLong(), b = get.nextLong();
 ...
 public static void ans( long a, long b ) throws java.lang.Exception
 {
  long ans = 0;

        if(a>b)
        {
         if(a%2 ==0) ans = a*a - (b-1);
         else ans = (a-1)*(a-1)+1 + (b-1);
        }
        else
        {
         if(b%2==0) ans = (b-1)*(b-1)+1 + (a-1);
         else ans = b*b -(a-1);
        }
 ...
 public static int[] readArr(int N, FastReader get) throws Exception
    ...
    public static void sortpair(ArrayList<Pair> list)
    {
