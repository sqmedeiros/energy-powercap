...
limitations under the License.
 Modifications: comments, docstrings, whitespace, some ancilliary methods removed.
https://github.com/grantjenks/python-sortedcontainers/blob/master/LICENSE
'''
...
[tickets, customers] = read_line_of_numbers()
prices = read_line_of_numbers()
targets = read_line_of_numbers()
payments = []
pricelist = SortedList(prices)
for target in targets:
    index = pricelist.bisect_right(target)
    if index == 0:
        payments.append(-1)
    else:
        payment = pricelist[index-1]
        payments.append(payment)
        pricelist.remove(payment)
print(*payments, sep='\n')