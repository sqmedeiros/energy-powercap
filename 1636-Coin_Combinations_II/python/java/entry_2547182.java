    ...
    static class Solver {
        ...
        void solve() {
            ...
            for (int coinIndex=0; coinIndex<n; coinIndex++) {
                for (int sourceSum=0; sourceSum<x; sourceSum++) {
                    int targetSum = sourceSum + c[coinIndex];
                    if (targetSum > x) continue;
                    dp[targetSum] += dp[sourceSum];
                    dp[targetSum] %= MOD;
                }
            }
