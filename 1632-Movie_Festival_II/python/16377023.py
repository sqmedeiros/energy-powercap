...
class SortedList:
    ...
    def lower_bound(self, x):
        """
        Returns the first index i such that self[i] >= x.
 
        In other words:
        - How many elements are STRICTLY LESS than x.
        - The position where x can be inserted (from the left).
    ...
    def upper_bound(self, x):
        ...
        In other words:
        - How many elements are LESS THAN OR EQUAL to x.
