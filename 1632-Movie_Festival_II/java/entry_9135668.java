...
public class entry_9135668 {

    public static boolean check (int[] arr, int k, String s)
    {
        if (s.charAt(0) == '0')
        {
            arr[0]++;
        ...
        {
            arr[i] += arr[i-1];
            if ((arr[i]%2 == 0 && s.charAt(i) == '0') || (arr[i]%2 == 1 && s.charAt(i) == '1'))
            {
                arr[i]++;
                if (i+k >= s.length()+1)
                    return false;
        ...
        {
            if ((s.charAt(i) == '1' && arr[i]%2 == 1) || (s.charAt(i) == '0' && arr[i]%2 == 0))
                return false;
        }
        return true;
    }
