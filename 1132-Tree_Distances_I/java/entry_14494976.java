...
public class entry_14494976 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // idea, once we know the two extremes, then we know the max distance from any node n to
        // another node will be to one of the two extremes.
        ...
        int[] ans = new int[n];
        for (int i = 0; i < n; i++) {
            ans[i] = Math.max(nodes[i].depth1, nodes[i].depth2);
        }
