...
public class entry_15793105 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int farthestDistanceFromNode = bfsDistance(farthestNode,n);
        System.out.println(farthestDistanceFromNode);
