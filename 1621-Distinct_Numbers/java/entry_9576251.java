...
public class entry_9576251 {
    //SOLUTION BEGIN
    void pre() throws Exception{}
    void solve(int TC) throws Exception {
        // for multiTestCase do, multiTC = true
    ...
    void run() throws Exception{
        // UPDATE
        boolean multipleTC = false;         // todo modify
    ...
    public static void main(String[] args) throws Exception{
        if(memory)new Thread(null, new Runnable() {public void run(){try{new entry_9576251().run();}catch(Exception e){e.printStackTrace();System.exit(1);}}}, "1", 1 << 26).start();
        else new entry_9576251().run();
    }
