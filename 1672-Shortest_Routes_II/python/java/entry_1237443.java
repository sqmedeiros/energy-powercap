...
import java.text.*;
public class entry_1237443 implements Runnable {
    static long mod = pow(2l , 32);
    ...
    public static void solve() {
        int n = f.ni(); int m = f.ni(); int q = f.ni();
        ...
        for (int i = 0; i < m; ++i) {
            int u = f.ni() - 1; int v = f.ni() - 1; int c = f.ni();
        ...
        for (int i = 0; i < q; ++i) {
            int u = f.ni() - 1; int v = f.ni() - 1;
            ans.append(dp[u][v] >= iinf ? -1 + "\n" : dp[u][v] + "\n");
        }
        pn(ans);
    }   

    public static void main(String[] args)throws IOException {
        new Thread(null , new entry_1237443() , "F*uckit" , 1 << 28).start();  
    }
